...
export default function CustomerMenu() {
  ...
  const getFinalTotal = () => {
    return getTotalPrice() + getDeliveryFee() + getServiceFee()
  }
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center space-x-4">
              <a href="/login" className="text-sm text-orange-600 hover:text-orange-700 underline">
                Admin Panel
              </a>
            </div>
          </div>
          ...
          <div className="fixed bottom-24 right-4 z-50">
            <Sheet open={isCartOpen} onOpenChange={setIsCartOpen}>
              <SheetTrigger asChild>
                <Button className="w-20 h-20 bg-gradient-to-r from-orange-600 to-red-600 hover:from-orange-700 hover:to-red-700 text-sm font-semibold shadow-xl rounded-full animate-bounce hover:animate-pulse transition-all duration-300 transform hover:scale-105">
                  ...
                  <div className="border-t pt-6 mt-6 space-y-4">
                    <div className="space-y-3">
                      <div className="flex justify-between items-center">
                        ...
                        <span className="font-semibold">{getTotalPrice().toLocaleString()} so'm</span>
                      </div>
                      <div className="flex justify-between items-center">
                        <span className="text-gray-600">Xizmat haqi (2%)</span>
                        <span className="font-semibold">{getServiceFee().toLocaleString()} so'm</span>
                      </div>
                      <div className="flex justify-between items-center">
                        <span className="text-gray-600">Yetkazib berish</span>
                        <span
                          className={`font-semibold ${getDeliveryFee() === 0 ? "text-green-600" : "text-gray-900"}`}
                        >
                          {getDeliveryFee() === 0 ? "Bepul" : `${getDeliveryFee().toLocaleString()} so'm`}
                        </span>
                      </div>
                      {getDeliveryFee() > 0 && (
                        <div className="text-xs text-gray-500 bg-yellow-50 p-3 rounded-lg border border-yellow-200">
                          💡 50,000 so'mdan yuqori buyurtmalarda yetkazib berish bepul
                        </div>
                      )}
                    </div>
                    ...
                    <div className="flex justify-between items-center text-xl font-bold">
                      ...
                      <span className="text-orange-600">{getFinalTotal().toLocaleString()} so'm</span>
                    </div>

                    <Button className="w-full bg-gradient-to-r from-orange-600 to-red-600 hover:from-orange-700 hover:to-red-700 h-14 text-lg font-semibold">
                    ...
                    <div className="grid grid-cols-2 gap-4 mt-4">
                      <div className="p-3 bg-green-50 rounded-xl border border-green-200">
                        <div className="flex items-center gap-2">
                          ...
                          <div>
                            <div className="font-medium text-green-900 text-sm">Yetkazib berish</div>
                            <div className="text-xs text-green-700">25-35 daqiqa</div>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="p-3 bg-blue-50 rounded-xl border border-blue-200">
                        <div className="flex items-center gap-2">
                          ...
                          <div>
                            <div className="font-medium text-blue-900 text-sm">Aloqa</div>
                            <div className="text-xs text-blue-700">+998 90 123 45 67</div>
                          </div>
                        </div>
                      </div>
                    </div>
                ...
                <div className="space-y-3">
                  <div className="flex justify-between items-center">
                    ...
                    <div className="flex items-center">
                      ...
                      <span className="font-medium">{selectedItem.rating || 0}</span>
                    </div>
                  </div>
